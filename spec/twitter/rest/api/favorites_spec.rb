...
describe Twitter::REST::API::Favorites do
  ...
  describe '#favorite!' do
    ...
    context 'forbidden' do
      before do
        stub_post('/1.1/favorites/create.json').with(:body => {:id => '25938088801'}).to_return(:status => 403, :body => '{"error":"forbidden"}', :headers => {:content_type => 'application/json; charset=utf-8'})
      end
